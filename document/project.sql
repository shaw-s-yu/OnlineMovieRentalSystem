...
CREATE TABLE `Account` (
  ...
  CONSTRAINT `account_ibfk_1` FOREIGN KEY (`CustomerId`) REFERENCES `person` (`SSN`)
...
INSERT INTO `Account` VALUES (1,444444444,'2006-10-01','Unlimited-2',20),(2,222222222,'2006-10-15','Limited',10);
...
CREATE TABLE `AppearedIn` (
  ...
  KEY `MovieId` (`MovieId`),
  CONSTRAINT `appearedin_ibfk_1` FOREIGN KEY (`ActorId`) REFERENCES `actor` (`Id`),
  CONSTRAINT `appearedin_ibfk_2` FOREIGN KEY (`MovieId`) REFERENCES `movie` (`Id`)
...
CREATE TABLE `Customer` (
  ...
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`CustomerId`) REFERENCES `person` (`SSN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Customer` VALUES (111111111,2,'1234-5678-1234-5678'),(222222222,1,'5678-1234-5678-1234'),(333333333,1,'2345-6789-2345-6789'),(444444444,1,'6789-2345-6789-2345');
...
INSERT INTO `Employee` VALUES (1,123456789,'2005-11-01',70,'Representative'),(2,789123456,'2006-02-02',50,'Manager');
...
INSERT INTO `Location` VALUES (11368,'corona','NY'),(11790,'Stony','NY'),(11794,'Stony Brook','NY'),(93536,'Los Angeles','CA');
...
CREATE TABLE `Login` (
  ...
  KEY `SSN` (`SSN`),
  CONSTRAINT `login_ibfk_1` FOREIGN KEY (`SSN`) REFERENCES `person` (`SSN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Login` VALUES (444444444,'philip.lewis@stonybrook.edu','123','0'),(111111111,'yang.shang@stonybrook.edu','123','0'),(222222222,'du.victor@stonyrbook.edu','123','0'),(333333333,'Simith.john@stonybrook.edu','123','0'),(123456789,'smith.david@stonybrook.edu','123','1'),(789123456,'warren.david@stonybrook.edu','123','2');
...
INSERT INTO `Movie` VALUES (1,'The great Father','Drama',5,10000,3),(2,'Shawshank Redemption','Drama',4,1000,2),(3,'Borat','Comedy',3,500,1);
...
CREATE TABLE `MovieOrder` (
  ...
  `MovieId` int(11) NOT NULL,
  PRIMARY KEY (`Id`,`AccountNumber`,`MovieId`),
  KEY `AccountNumber` (`AccountNumber`),
  KEY `MovieId` (`MovieId`),
  CONSTRAINT `movieorder_ibfk_1` FOREIGN KEY (`AccountNumber`) REFERENCES `account` (`Id`),
  CONSTRAINT `movieorder_ibfk_2` FOREIGN KEY (`MovieId`) REFERENCES `movie` (`Id`)
...
INSERT INTO `MovieOrder` VALUES (1,'2009-11-11 10:00:00','2009-11-14',1,1),(2,'2009-11-11 18:15:00','2019-12-04',2,3),(3,'2009-11-12 09:30:00',NULL,1,3),(4,'2009-11-21 22:22:00',NULL,2,2);
...
CREATE TABLE `MovieQ` (
  ...
  KEY `MovieId` (`MovieId`),
  CONSTRAINT `movieq_ibfk_1` FOREIGN KEY (`AccountId`) REFERENCES `account` (`Id`),
  CONSTRAINT `movieq_ibfk_2` FOREIGN KEY (`MovieId`) REFERENCES `movie` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Person` VALUES (111111111,'Yang','Shang','456',11790,'516-632-4360','yang.shang@stonybrook.edu'),(123456789,'Smith','David','123',11790,'516-215-2345','smith.david@stonybrook.edu'),(222222222,'Du','Victor','456',11790,'516-632-4360','du.victor@stonyrbook.edu'),(333333333,'Smith','John','789 wefff',93536,'315-443-4321','Simith.john@stonybrook.edu'),(444444444,'Philip','Lewis','135 Knowledge Lane',11794,'516-666-8888','philip.lewis@stonybrook.edu'),(789123456,'Warren','David','456 Sunken Street',11794,'631-632-9987','warren.david@stonybrook.edu');
...
CREATE TABLE `Rental` (
  ...
  KEY `OrderId` (`OrderId`),
  CONSTRAINT `rental_ibfk_1` FOREIGN KEY (`AccountId`) REFERENCES `account` (`Id`),
  CONSTRAINT `rental_ibfk_2` FOREIGN KEY (`MovieId`) REFERENCES `movie` (`Id`),
  CONSTRAINT `rental_ibfk_3` FOREIGN KEY (`CustRepId`) REFERENCES `employee` (`Id`),
  CONSTRAINT `rental_ibfk_4` FOREIGN KEY (`OrderId`) REFERENCES `movieorder` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-12-04 15:51:31',NULL),('diagnostics.include_raw','OFF','2019-12-04 15:51:31',NULL),('ps_thread_trx_info.max_length','65535','2019-12-04 15:51:31',NULL),('statement_performance_analyzer.limit','100','2019-12-04 15:51:31',NULL),('statement_performance_analyzer.view',NULL,'2019-12-04 15:51:31',NULL),('statement_truncate_len','64','2019-12-04 15:51:31',NULL);
...
-- Dump completed on 2019-12-04 12:57:20
