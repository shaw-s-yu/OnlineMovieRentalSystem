		...
		<div class="container">
			...
			<div class="row">
					  ...
					  <div class="card-body">
    					...
    					<div class="container">
							<form action="getMovies">
								<input type="submit" value="View Movies" class="btn btn-primary"/>
							</form>
						</div>
					  </div>
					</div>
				...
				<div class="col">
					<div class="card">
					  <div class="card-body">
					    <h5 class="card-title">Search Movies Rental</h5>
    					<div class="container">
							<form action="searchMovieRentals">
								<input type="submit" value="Search Rentals" class="btn btn-primary"/>
							</form>
						</div>
					  </div>
					</div>
...
<!-- 				<div class="col">
	...
	<!-- 			<div class="col">
				...
				<div class="col">
					<div class="card">
					  <div class="card-body">
					    <h5 class="card-title">View Bestseller Movies</h5>
    					<div class="container">
